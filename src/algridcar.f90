...
!  write (8,*) 'zone i =',mx,' j =',my,' k = ',mz,' f = block'
!  write (8,*) (((x(i),i=1,mx),j=1,my),k=1,mz)
!  write (8,*) (((y(j),i=1,mx),j=1,my),k=1,mz)
!  write (8,*) (((z(k),i=1,mx),j=1,my),k=1,mz)
!  close (8)
